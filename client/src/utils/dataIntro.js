export const textIntro = {
  ...
  description:
    "Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng F3-HUTECH tự hào là trang web đứng top google về các từ khóa: ",
  description2:
